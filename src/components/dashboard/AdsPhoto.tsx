...
export default function AdsPhoto() {
  ...
  const [productLink, setProductLink] = useState(
    "https://yourstore.com/product/awesome-gadget",
  );
  ...
  function handleAddMoreAssets(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const newAssetUrls = Array.from(files).map((file) => {
    ...
    setAssets((prevAssets) => {
      const startIndex = prevAssets.length;
      const newIndexes = newAssetUrls.map((_, offset) => startIndex + offset);
      setSelectedAssets((prevSelected) => [...prevSelected, ...newIndexes]);
      return [...prevAssets, ...newAssetUrls];
    });
      ...
      <div className="mx-auto">
        ...
        <div className="mt-7 flex justify-center">
          <div className="inline-flex rounded-full bg-[#e8edf5] p-1 shadow-[inset_0_0_0_1px_rgba(49,70,129,0.08)]">
            <button className="inline-flex items-center gap-2 rounded-full bg-white px-7 py-2 text-sm font-semibold text-[#264289] shadow-[0_4px_12px_rgba(55,76,132,0.16)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#f7f9ff] hover:shadow-[0_8px_18px_rgba(55,76,132,0.22)]">
              <FiImage className="h-4 w-4" />
              Photo
            </button>
            <Link href="/Content/adsVideo">
        ...
        <div className="mt-10 text-center">
          <h1 className="text-4xl font-bold tracking-[-0.02em] text-[#13327a] md:text-5xl">
            Create New Ad Campaign
          </h1>
          <p className="mx-auto mt-3 max-w-162.5 text-lg text-[#697d9a]">
            Let Nebula AI transform your product link into high-converting ad
            assets.
          </p>
        </div>
        ...
        <div className="mt-10 rounded-3xl bg-white/90 p-6 shadow-[0_14px_35px_rgba(35,58,107,0.08)] md:p-9">
          <div>
            <label className="mb-3 block text-2xl font-semibold text-[#163887] md:text-[30px]">
              Product Link
            </label>
            <div className="flex items-center gap-3 rounded-2xl bg-[#eef2f7] px-4 py-4">
              ...
              <input
                ...
                className="w-full bg-transparent text-[17px] text-[#5f6f87] outline-none placeholder:text-[#8b99ae]"
                placeholder="https://yourstore.com/product/awesome-gadget"
              />
            </div>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-10">
            <div>
              <label className="mb-3 block text-[28px] font-semibold text-[#163887]">
                Upload Logo{" "}
                <span className="text-lg font-medium text-[#a6b1c4]">
                  (Optional)
                </span>
              </label>
              <label className="flex h-32.5 cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[#d4dcea] bg-[#fbfcfe] px-4 text-center">
                ...
                <div className="mt-2 text-base text-[#7a879d]">
                  Drop your logo here or{" "}
                  <span className="font-semibold text-[#2c4995]">browse</span>
                </div>
                {logoName && (
                  <span className="mt-2 text-xs font-medium text-[#5670ae]">
                    {logoName}
                  </span>
                )}
              </label>
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <label
                  className="h-16 w-16 cursor-pointer overflow-hidden rounded-sm border border-[#d8e0ef] shadow-[0_6px_18px_rgba(19,50,122,0.12)]"
                ...
                <input
                  value={brandColor}
                  onChange={(e) => setBrandColor(e.target.value)}
                  className="h-14 flex-1 rounded-xl bg-[#eef2f7] px-5 text-lg text-[#586984] outline-none placeholder:text-[#9ba8be]"
                  placeholder="e ex Code: #1D3B91"
                />
              </div>
            </div>
          </div>
          ...
          <div className="mt-11 flex justify-center">
            <button className="rounded-full bg-linear-to-r from-[#323aa7] via-[#4f4bc2] to-[#d2529a] px-10 py-4 text-lg font-semibold text-white shadow-[0_14px_30px_rgba(75,57,165,0.35)] transition-transform hover:scale-[1.02]">
              Analyze Product
            </button>
          </div>
        </div>
        ...
        <div className="mt-9 flex items-center gap-4 text-center">
          ...
          <span className="text-xs font-semibold uppercase tracking-[0.22em] text-[#90a0b8]">
            Analysis Results
          </span>
          <div className="h-px flex-1 bg-[#d9e0ea]" />
        </div>
        ...
        <div className="mt-6 rounded-3xl bg-white/90 p-6 shadow-[0_12px_28px_rgba(36,57,104,0.07)] md:p-8">
          <div className="space-y-5">
            <div>
              <h3 className="text-[30px] font-semibold text-[#173a8a]">
                Product Name
              </h3>
              <div className="mt-2 rounded-2xl bg-[#eef2f7] px-4 py-3 text-[24px] font-semibold text-[#153a89]">
                Lumina Wireless Headphones
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 rounded-2xl bg-[#eef2f7] px-4 py-4 text-xl leading-relaxed text-[#54667f]">
                Experience pure sound with Lumina. Featuring active noise
                cancellation, 40-hour battery life, and ultra-soft memory foam
                ear cups for all-day comfort. Engineered for those who
                appreciate every detail in their music.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-9 flex items-end justify-between">
          <div>
            <h3 className="text-[34px] font-semibold text-[#1c2f53]">
              Visual Assets
            </h3>
            <p className="text-lg text-[#6b7b94]">
              Selected images from your product link
            </p>
          </div>
          <button
            onClick={selectAllAssets}
            className="text-lg font-semibold text-[#2f57a3]"
          >
            Select All
          </button>
        </div>
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-5 md:gap-4">
          ...
          <label className="flex h-31.5 cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[#d5ddeb] bg-[#f7f9fd] text-center">
            ...
            <div className="mt-2 text-sm font-semibold tracking-[0.12em] text-[#9ca8bc]">
              ADD MORE
            </div>
          </label>
        </div>
        ...
        <div className="mt-10 text-center">
          <h3 className="text-[34px] font-semibold text-[#425577]">
            Ready to see the magic?
          </h3>
          <p className="text-base text-[#94a1b5]">
            I-create will generate variations including Social, Search, and
            Display ads.
          </p>
        </div>
        ...
        <div className="mt-7 rounded-3xl bg-white/90 p-5 shadow-[0_10px_24px_rgba(35,58,107,0.08)] md:p-7">
          <div className="grid gap-5 md:grid-cols-3 md:gap-8">
            <div>
              <div className="text-xs font-bold tracking-[0.16em] text-[#8696af]">
                ASPECT RATIO
              </div>
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-lg px-3 py-2 text-xs font-semibold transition-colors ${
                        isActive
                          ? "bg-white text-[#2f4d97] shadow-sm"
                          : "text-[#7888a2] hover:text-[#5e7090]"
                      }`}
                    >
                      {option}
                    </button>
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <select
                  ...
                  className="h-10 min-w-44 rounded-xl bg-[#eef2f7] pl-9 pr-8 text-sm font-semibold text-[#4f5f79] outline-none"
                >
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-3">
                <button
                  onClick={() =>
                    setVariationCount((prev) => Math.max(1, prev - 1))
                  }
                  className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#eef2f7] text-[#65758f]"
                >
                  <FiMinus className="h-4 w-4" />
                </button>
                <span className="min-w-6 text-center text-lg font-semibold text-[#2f4d97]">
                  {variationCount}
                </span>
                <button
        ...
        <div className="mt-9 mb-4 flex justify-center">
          <button className="inline-flex items-center gap-3 rounded-full bg-linear-to-r from-[#323aa7] via-[#4f4bc2] to-[#d2529a] px-11 py-4 text-3xl font-semibold text-white shadow-[0_14px_30px_rgba(75,57,165,0.35)] transition-transform hover:scale-[1.02]">
