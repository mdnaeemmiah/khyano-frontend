...
import { FiAperture, FiFileText, FiFolder, FiVideo, FiSearch, FiBell } from "react-icons/fi";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <>
            {/* Fixed sidebar (styled to match design perfectly) */}
            <aside className="fixed top-0 left-0 h-screen w-[260px] bg-[#f8fbff] border-r border-[#eef2f6] flex flex-col z-30">
                {/* Logo Area */}
            ...
            {/* Fixed top bar */}
            <header className="fixed top-0 left-[260px] right-0 h-[80px] bg-white border-b border-[#eef2f6] flex items-center px-10 z-20 justify-end">
            ...
            <div className="min-h-screen pt-[80px] pl-[260px] bg-white">
